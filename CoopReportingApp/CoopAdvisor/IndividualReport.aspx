...
each question:
    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <asp:RadioButton ID="RadioButton5" GroupName="intership" Text="Definitelt Not" runat="server" />
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <asp:RadioButton ID="RadioButton10" GroupName="adequately" Text="Definitelt Not" runat="server" />
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <asp:RadioButton ID="RadioButton15" GroupName="Curriculum" Text="Definitelt Not" runat="server" />
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <asp:RadioButton ID="RadioButton20" GroupName="Expectation" Text="Definitelt Not" runat="server" />
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <asp:RadioButton ID="RadioButton25" GroupName="Requirement" Text="Definitelt Not" runat="server" />
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <asp:RadioButton ID="RadioButton30" GroupName="AboutCoopAdvisor" Text="Definitelt Not" runat="server" />
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <asp:RadioButton ID="RadioButton35" GroupName="AgencySupervisor" Text="Definitelt Not" runat="server" />
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <asp:RadioButton ID="RadioButton40" GroupName="SupervisorActive" Text="Definitelt Not" runat="server" />
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <asp:RadioButton ID="RadioButton45" GroupName="Attendance" Text="Definitelt Not" runat="server" />
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <asp:RadioButton ID="RadioButton50" GroupName="Punctuality" Text="Definitelt Not" runat="server" />
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <asp:RadioButton ID="RadioButton55" GroupName="Structured" Text="Definitelt Not" runat="server" />
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <asp:RadioButton ID="RadioButton60" GroupName="OverStructured" Text="Definitelt Not" runat="server" />
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <asp:RadioButton ID="RadioButton65" GroupName="Problems" Text="Definitelt Not" runat="server" />
        </div>
    </div>
    <p>
...
agencysupervisor? Please explain.
    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <asp:RadioButton ID="RadioButton70" GroupName="HelpProblems" Text="Definitelt Not" runat="server" />
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <asp:RadioButton ID="RadioButton75" GroupName="Learning" Text="Definitelt Not" runat="server" />
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <asp:RadioButton ID="RadioButton80" GroupName="Rewarding" Text="Definitelt Not" runat="server" />
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <asp:RadioButton ID="RadioButton85" GroupName="ObjectiveEstablished" Text="Definitelt Not" runat="server" />
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <asp:RadioButton ID="RadioButton90" GroupName="Recommend" Text="Definitelt Not" runat="server" />
        </div>
    </div>
