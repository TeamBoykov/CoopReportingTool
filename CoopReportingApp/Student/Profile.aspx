...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <asp:TextBox ID="txtAddress1" CssClass="form-control" placeholder="Address1" runat="server"></asp:TextBox>
        ...
        <div class="col-md-12">
            ...
            <asp:TextBox ID="txtAddress2" CssClass="form-control" placeholder="Address2" runat="server"></asp:TextBox>
            <%-- <asp:RequiredFieldValidator ErrorMessage="Address required" Font-Size="X-Small" ForeColor="Red" ControlToValidate="txtAddress1"
                runat="server"  SetFocusOnError="True" />--%>
        </div>
        <div class="col-md-12">
        ...
        <div class="col-md-12">
            ...
            <asp:TextBox ID="txtPostalCode" CssClass="form-control" placeholder="" runat="server"></asp:TextBox>
        ...
        <div class="col-md-12">
            ...
            <asp:TextBox ID="txtProgram" CssClass="form-control" placeholder="Program" runat="server"></asp:TextBox>
            <%-- <asp:RequiredFieldValidator ErrorMessage="Address required" Font-Size="X-Small" ForeColor="Red" ControlToValidate="txtAddress1"
                runat="server"  SetFocusOnError="True" />--%>
        </div>
        <div class="col-md-12">
            <asp:Label ID="Label8" runat="server" Text="Current WorkTerm:"></asp:Label>
            <asp:TextBox ID="txtCurrentWorkTerm" CssClass="form-control" placeholder="Current WorkTerm" runat="server"></asp:TextBox>
            <%-- <asp:RequiredFieldValidator ErrorMessage="Address required" Font-Size="X-Small" ForeColor="Red" ControlToValidate="txtAddress1"
                runat="server"  SetFocusOnError="True" />--%>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
             <asp:Label ID="lblWorkTerm1" runat="server" Text="--"></asp:Label>
        </div>
    </div>
    <hr />
     <div class="row">
        ...
        <div class="col-md-6">
             <asp:Label ID="lblWorkTerm2" runat="server" Text="--"></asp:Label>
        </div>
    </div>
    <hr />
     <div class="row">
        ...
        <div class="col-md-6">
             <asp:Label ID="lblWorkTerm3" runat="server" Text="--"></asp:Label>
        </div>
    </div>
    <hr />
     <div class="row">
        ...
        <div class="col-md-6">
             <asp:Label ID="lblWorkTerm4" runat="server" Text="--"></asp:Label>
        </div>
    </div>
    <hr />
     <div class="row">
